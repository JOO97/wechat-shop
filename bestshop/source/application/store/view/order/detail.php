                    ...
                    <div class="am-scrollable-horizontal">
                        <table class="regional-table am-table am-table-bordered am-table-centered
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $detail['pay_status']['value'] == 10 && $detail['order_status']['value'] == 10? '<p>待支付</p>':'' ?>
                                    <?= $detail['delivery_status']['value'] == 10 && $detail['pay_status']['value'] == 20? '<p>待发货</p>':'' ?>
                                    <?= $detail['receipt_status']['value'] == 10 && $detail['delivery_status']['value'] == 20? '<p>待收货</p>':'' ?>
                                    <?= $detail['order_status']['value'] == 30 && $detail['receipt_status']['value'] == 20? '<p>已完成</p>':'' ?>
                                    <?= $detail['order_status']['value'] == 20? '<p>已取消</p>':'' ?>
<!--                                    <p>付款状态：-->
<!--                                        <span class="am-badge-->
                            ...
                            <form id="delivery" class="my-form am-form tpl-form-line-form" method="post"
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" class="tpl-form-input" name="order[express_man]"
                                               required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" class="tpl-form-input" name="order[express_phone]" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                        ...
                        <?php else: ?>
                            <div class="am-scrollable-horizontal">
                                ...
                                am-text-nowrap am-margin-bottom-xs">
                                    ...
                                    <tr>
                                        <td><?= $detail['express_man'] ?></td>
                                        <td><?= $detail['express_phone'] ?></td>
                                        <td>
