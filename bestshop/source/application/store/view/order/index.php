...
<!--                                                <p class="am-link-muted">(含运费：￥--><?//= $order['express_price'] ?><!--)</p>-->
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <?= $order['pay_status']['value'] == 10 && $order['order_status']['value'] == 10? '<p>待支付</p>':'' ?>
                                                <?= $order['delivery_status']['value'] == 10 && $order['pay_status']['value'] == 20? '<p>待发货</p>':'' ?>
                                                <?= $order['receipt_status']['value'] == 10 && $order['delivery_status']['value'] == 20? '<p>待收货</p>':'' ?>
                                                <?= $order['order_status']['value'] == 30 && $order['receipt_status']['value'] == 20? '<p>已完成</p>':'' ?>
                                                <?= $order['order_status']['value'] == 20? '<p>已取消</p>':'' ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <?php if ($order['pay_status']['value'] == 20
                                                        && $order['delivery_status']['value'] == 10 && $order['order_status']['value'] != 20 && $order['order_status']['value'] != 21): ?>
