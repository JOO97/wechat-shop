...
Page({
  ...
  getGoodsList: function (is_super, page) {
    ...
    App._get('goods/lists', {
      ...
      sortSales: _this.data.sortSales? 1 : 0,      
  ...
  switchSortType: function (e) {
    ...
    if(newSortType=='price'){
      ...
      let newSortSales = newSortType === 'sales' ? !_this.data.sortSales : true;
      _this.setData({
        list: {},
        page: 1,
        sortType: newSortType,
        sortPrice: false,
        sortSales: newSortSales
      }, function () {
        // 获取商品列表
        _this.getGoodsList(true);
      });
    } else if (newSortType == 'all'){
      let newSortSales = newSortType === 'salse' ? !_this.data.sortSalse : true;
      _this.setData({
        list: {},
        page: 1,
        sortType: newSortType,
